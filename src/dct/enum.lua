...
enum.assetTypePriority = {
	...
	[enum.assetType.SAM]         = 10,
	[enum.assetType.C2]          = 10,
	[enum.assetType.LRC2]        = 20,
	[enum.assetType.AMMODUMP]    = 10,
	[enum.assetType.LRAMMODUMP]  = 20,
	[enum.assetType.FUELDUMP]    = 10,
	[enum.assetType.LRFUELDUMP]  = 20,
	[enum.assetType.ARTILLERY]   = 10,
	[enum.assetType.CONVOY]      = 10,
	[enum.assetType.MISSILE]     = 10,
	[enum.assetType.LRMISSILE]   = 20,
	[enum.assetType.SEA]         = 25,
	[enum.assetType.FRONTLINE]   = 10,
	[enum.assetType.BASEDEFENSE] = 10,
	[enum.assetType.OCA]         = 10,
	[enum.assetType.LROCA]       = 20,
	[enum.assetType.PORT]        = 20,
	[enum.assetType.LOGISTICS]   = 10,
	[enum.assetType.AIRBASE]     = 10,
	[enum.assetType.SHORAD]      = 10,
	[enum.assetType.FACILITY]    = 10,
	[enum.assetType.LRFACILITY]  = 20,
	[enum.assetType.BUNKER]      = 10,
	[enum.assetType.LRBUNKER]    = 20,
	[enum.assetType.CHECKPOINT]  = 10,
	[enum.assetType.SPECIALFORCES] = 10,
	[enum.assetType.INSURGENCY]  = 10,
	[enum.assetType.FOB]         = 10,
	[enum.assetType.FACTORY]     = 10,
	[enum.assetType.LRFACTORY]   = 20,
	[enum.assetType.STRATEGIC]   = 20,
